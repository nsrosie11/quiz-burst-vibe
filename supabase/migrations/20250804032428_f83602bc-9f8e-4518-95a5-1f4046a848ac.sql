-- Add missing English category first
...
-- Add corresponding levels for English category
INSERT INTO public.quiz_levels (category_id, level_number, name, difficulty, max_points, questions_count) VALUES
('english', 1, 'Basic Grammar', 'easy', 100, 5),
('english', 2, 'Vocabulary Builder', 'medium', 150, 5),
('english', 3, 'Advanced Literature', 'hard', 200, 5);
